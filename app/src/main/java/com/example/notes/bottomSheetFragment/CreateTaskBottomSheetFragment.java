...
import com.example.notes.broadcastReceiver.AlarmBroadcastReceiver;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, Upcomingctivity activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
